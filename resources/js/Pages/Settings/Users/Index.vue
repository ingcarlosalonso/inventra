        ...
        >
          ...
          <div class="flex items-center gap-1.5">
            <span
              ...
              :key="role.id"
              class="inline-flex items-center rounded-full bg-violet-100 px-2.5 py-0.5 text-xs font-medium text-violet-700"
            >
              {{ role.name }}
            </span>
            <span v-if="!item.roles.length" class="text-xs text-gray-400">{{ $t('users.no_role') }}</span>
          </div>
