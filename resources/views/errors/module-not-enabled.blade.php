...
<body>
    <div class="card">
        ...
        <p>Esta funcionalidad no está contratada para tu cuenta. Por favor contactá al administrador para activarla.</p>
        <p class="contact">Si creés que es un error, escribinos a <strong>soporte@in-ventra.com</strong></p>
    </div>
</body>
</html>
