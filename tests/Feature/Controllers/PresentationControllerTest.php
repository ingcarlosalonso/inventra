...
class PresentationControllerTest extends TenantFeatureTestCase
{
    ...
    public function test_index_returns_list(): void
    {
        ...
        $this->actingAs($this->user, 'sanctum')
            ->getJson('/api/v1/products/presentations')
            ->assertOk()
    ...
    public function test_index_filters_by_search(): void
    {
        ...
        $this->actingAs($this->user, 'sanctum')
            ->getJson('/api/v1/products/presentations?search=__TIPO_KG__')
            ->assertOk()
    ...
    {
        $this->getJson('/api/v1/products/presentations')->assertUnauthorized();
    }
    ...
    public function test_store_creates_presentation(): void
    {
        ...
        $this->actingAs($this->user, 'sanctum')
            ->postJson('/api/v1/products/presentations', [
