...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('orders', function (Blueprint $table) {
            ...
            if (! Schema::hasColumn('orders', 'requires_delivery')) {
                $table->boolean('requires_delivery')->default(false)->after('notes');
            }
            if (! Schema::hasColumn('orders', 'delivery_date')) {
                $table->date('delivery_date')->nullable()->after('requires_delivery');
            }
    ...
    public function down(): void
    {
        Schema::table('orders', function (Blueprint $table) {
            $table->dropColumn([
                'currency_id', 'requires_delivery', 'delivery_date',
